        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Añadir un nuevo miembro al equipo, permitiéndoles colaborar contigo.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Por favor, proporciona la dirección de correo electrónico de la persona a la que te gustaría añadir a este equipo.') }}
                        </div>
                    </div>
